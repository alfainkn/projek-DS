...
shinyUI(fluidPage(
  tags$head(
    ...
    sidebarPanel(
      textInput("searchquery", "Twitter Search Query: ", value="#jokowi3periode"),
      sliderInput("sentimentN", "Tweet Sample Size for Sentiment Analysis: ", value=100, min=1, max=1600),
      sliderInput("freqN", "Tweet Sample Size for Frequency Analysis: ", value=400, min=1, max=1600),
    ...
    mainPanel(
      tabsetPanel(
        ...
        ##tabPanel("WordCloud", withLoader(plotOutput("wordcloud"), type="image", loader="https://thumbs.gfycat.com/YellowishElementaryHind-max-1mb.gif"))
      )
    ))
)
